...
function drawLines(percentage) {
    ...
    else if(percentage <= 50)  { document.getElementsByClassName("bottom")[0].style.width = parseInt((percentage - 16) / 34 * 428) + "px"; drawLines(16); }
    else if(percentage <= 66) { document.getElementsByClassName("right")[0].style.height = parseInt((percentage - 50) / 16 * 205) + "px"; drawLines(50); }
    else { document.getElementsByClassName("top")[0].style.width = parseInt((percentage - 66) / 34 * 428) + "px"; drawLines(66); }
}